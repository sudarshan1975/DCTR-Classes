...
[SSRN Paper](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4549617)
...
8. RADIS utilizes a third-party Python library (SymPy) to estimate line intensity split weights between bins, whereas DCTR calculates these weights analytically, thereby saving significant CPU time (DCTR also generalizes the weight split to any number of bins, as opposed to two bins only in RADIS)
...
[Figshare executable code](https://figshare.com/articles/dataset/DCTR_files_/24269011)

There is a separate README.docx file in the above location, which indicates how to use the (Windows only) executable.
